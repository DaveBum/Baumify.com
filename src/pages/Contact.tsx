                ...
                <Button variant="hero" size="lg" asChild className="w-full justify-start">
                  <a href="tel:+19015176300" className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm opacity-90">+1 (901) 517-6300</div>
                    </div>
                  </a>
                </Button>
              ...
              <div className="space-y-4 text-sm">
                <div className="flex space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground">Understand your vision and requirements</div>
                  </div>
                </div>
                <div className="flex space-x-3">
                  <div className="w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center text-xs font-mono">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground">Technical approach, timeline, and investment</div>
                  </div>
                </div>
                <div className="flex space-x-3">
                  <div className="w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center text-xs font-mono">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground">Sprint planning and development kickoff</div>
                  </div>
                </div>
              </div>
            </div>
